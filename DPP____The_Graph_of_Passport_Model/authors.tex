...
\address[aff5]{Department of Chemical Engineering, Norwegian University of Science and Technology (NTNU), Trondheim, Norway}

\address[aff1]{Luxembourg Institute of Science and Technology (LIST), Esch-sur-Alzette, Luxembourg}

% \address[aff2]{School of Engineering, Cardiff University, Cardiff, United Kingdom}

\address[aff3]{Fraunhofer Institute for Industrial Mathematics (ITWM), Kaiserslautern, Germany}

% \address[aff4]{AFNOR Group, Saint-Denis, France}

\address[aff6]{Faculty of Science and Technology, Norwegian University of Life Sciences (NMBU), Ås, Norway}
