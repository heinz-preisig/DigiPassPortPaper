...
\newcommand{\ac}[2]{\pdfmarkupcomment[%
markup=Underline,color=blue,opacity=0]{#1}{#2}}
...
\newcommand{\CENELEC}{\ac{CENELEC}{European Committee for Electrotechnical
Standardization}}
...
\newcommand{\eIDAS}{\ac{eIDAS}{Electronic Identification, Authentication and
Trust Services}}
\newcommand{\EN}{\ac{EN}{European Norm}}
\newcommand{\EO}{\ac{EO}{Economic Operator}}
\newcommand{\EORI}{\ac{EORI}{Economic Operators' Registration and
Identification}}
...
\newcommand{\OECD}{\ac{OECD}{Organisation for Economic Co-operation and
Development}}
\newcommand{\OWL}{\ac{OWL}{Web Ontology Language}}
\newcommand{\PDF}{\ac{PDF}{Portable Document Format}}
\newcommand{\PubChem}{\ac{PubChem}{world's largest collection of freely
accessible chemical information}}
\newcommand{\QR}{\ac{QR}{Quick Response}}
\newcommand{\REACH}{\ac{REACH}{Registration, Evaluation, Authorisation and
...
\newcommand{\RDFS}{\ac{RDFS}{Extension of RDF allowing for definition of classes
and properties}}
...
% \newcommand{\UNCEFACT}{\ac{UN/CEFACT}{United Nations Centre for Trade
...
\newcommand{\WthreeC}{\ac{W3C}{World Wide Web Consortium}}%
% <-- renamed from \W3C
