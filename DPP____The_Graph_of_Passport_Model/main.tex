...
\input{3_Network_model}
\input{4_portal_architecture}
\input{5_ABAC_framework}
\input{6_SHACL_data_modelling}
\input{7_chemical_data_governance}
\input{8_discussion}
\input{9_conclusions}
...
The author(s) have not employed any Generative AI tools for analysing the
conference transcripts, the post-conference report, and proofreading.
